...
## Percent vs decimal — get fluent

The same number wears two outfits. **5%** and **0.05** mean the same thing: 5 per 100. To convert, divide the percentage by 100 (5% → 0.05) or multiply the decimal by 100 (0.05 → 5%).

Formulas always want the decimal form. If you invest $200 and earn 5%, your gain is $200 × 0.05 = $10 — not $200 × 5. Mixing these up is the most common beginner slip, so pause here until it feels automatic.
...
- **Simple returns** answer money questions: "how many dollars did the portfolio make?" Portfolio returns across *assets* combine with simple returns (they average, weighted by how much you hold of each).
